                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="{{ route('danh-muc-bo-suu-tap.update', $categoryGallery->slug) }}" method="post"
                                ...
                                <div class="form-group"><label for="title" class=" form-control-label">Tên danh mục</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="title" name="name" value="{{ $categoryGallery->name }}"
                                ...
                                <div class=" form-group"><label for="slug" class=" form-control-label">Đường dẫn URL</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="text" id="slug" name="slug" value="{{ $categoryGallery->slug }}"
