                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <form action="">
                                            ...
                                            <select name="sort" id="sort" class="form-control"
                                                ...
                                                <option value="?status=1">Danh mục đang hiện</option>
                                                <option value="?status=0">Danh mục đã ẩn</option>
                            ...
                            <table id="bootstrap-data-table " class="table table-striped table-bordered text-center">
                                ...
                                <tbody id="cate">
                                    @foreach ($cate_gallery as $value)
                                        <tr id="{{ $value->id }}">
                                            <td>{{ $value->name }}</td>
                                            <td>{{ $value->slug }}</td>
                                            <td>{{ $value->getGallery->count() ? $value->getGallery->count() : 0 }}</td>
                                            @if ($value->status == 0)
                                                <td><a
                                                        href="{{ route('admin.category_gallery.unactive', $value->slug) }}"><span><i
                                                                class="fa fa-thumbs-o-down text-danger"
                                                                aria-hidden="true"></i></span></a></td>
                                            @else
                                                <td><a href="{{ route('admin.category_gallery.active', $value->slug) }}"><span><i
                                                                class="fa fa-thumbs-o-up text-success"
                                                                aria-hidden="true"></i></span></a>
                                                </td>
                                            @endif
                                            <td>
                                                <a href="{{ route('danh-muc-bo-suu-tap.edit', $value->slug) }}"
                                                    class="btn">
                                                    <span><i class="fa fa-pencil-square-o text-primary"
                                                            aria-hidden="true"></i></span></a>
                                                <a class="deleteRecord"
                                                    href="{{ route('danh-muc-bo-suu-tap.destroy', $value->slug) }}"
                            ...
                            <div class="col-sm-12 col-xs-12 d-flex">
                                <div class="col-sm-6 col-xs-12">
                                    <a href="{{ route('danh-muc-bo-suu-tap.create') }}" class="btn btn-outline-success">Thêm mới
                                        </a>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    {!! $cate_gallery->appends(\Request::except('page'))->render() !!}
    ...
    <script type="text/javascript">
        ...
        $('#product').change(function() {
            ...
            $.ajax({
                ...
                //         <td><a href="/admin/danh-muc-bo-suu-tap/${response[i].slug}/edit" class="btn"><span><i class="fa fa-pencil-square-o text-primary" aria-hidden="true"></i></span></a>
