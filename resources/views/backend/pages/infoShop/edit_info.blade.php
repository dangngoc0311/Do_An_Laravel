...
@section('main')
    ...
    <div class="content">
        <div class="animated fadeIn">
            <form action="{{ route('thong-tin-shop.update', $infoShop->id) }}" method="post" class="horizontal"
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                @csrf @method('PUT')
                                <input type="hidden" name='id' value="{{ $infoShop->id }}">
                                <div class="form-group"><label for="name" class=" form-control-label">Name</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="text" id="name" name="name" value="{{ $infoShop->name }}"
                                ...
                                <div class="form-group"><label for="email" class=" form-control-label">Email</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="email" id="email" name="email" value="{{ $infoShop->email }}"
                                            class="form-control-success form-control">
                                    </div>
                                    @error('email')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class=" form-group"><label for="phone" class=" form-control-label">Phone</label>
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="phone" name="phone"
                                            class="form-control-success form-control" value="{{ $infoShop->phone }}">
                                    </div>
                                    @error('phone')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class=" form-group"><label for="address" class=" form-control-label">Address</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="address" name="address"
                                            class="form-control-success form-control" value="{{ $infoShop->address }}">
                                    </div>
                                    @error('address')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ url('uploads') }}/{{ $infoShop->logo }}" alt="" srcset=""
