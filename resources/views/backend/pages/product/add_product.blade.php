...
@section('main')
    ...
    <div class="content">
        <div class="animated fadeIn">
            <form action="{{ route('san-pham.store') }}" method="post" class="horizontal" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="sale_price" class=" form-control-label">Gía sale</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="number" id="sale_price" name="sale_price"
                                            value="{{ old('sale_price') }}" class="form-control-success form-control">
                                    </div>
                                    @error('sale_price')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                        ...
                                        <select name="brand_id" id="select1" class="form-control">
                                            ...
                                            @foreach ($brand as $brands)
                                                <option value="{{ $brands->id }} "
                                                    {{ old('brand_id') == $brands->id ? 'selected' : '' }}>
                                                    {{ $brands->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
