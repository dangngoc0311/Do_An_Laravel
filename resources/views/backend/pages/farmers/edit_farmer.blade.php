...
@section('main')
    <div class="content">
        <div class="animated fadeIn">
            <form action="{{ route('nhan-vien.update', $farmer->id) }}" method="post" class="form-horizontal"
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="name" class=" form-control-label">Tên nhân viên</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="name" name="name" value="{{ $farmer->name }}"
                                ...
                                <div class="form-group"><label for="email" class=" form-control-label">Email</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="emzil" id="email" name="email" value="{{ $farmer->email }}"
                                            class="form-control-success form-control">
                                    </div>
                                    @error('email')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group"><label for="phone" class=" form-control-label">Phone</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="emzil" id="phone" name="phone" value="{{ $farmer->phone }}"
                                            class="form-control-success form-control">
                                    </div>
                                    @error('phone')
                                        <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group"><label for="address" class=" form-control-label">Địa chỉ</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="text" id="address" name="address" value="{{ $farmer->address }}"
                                            class="form-control-success form-control">
                                    </div>
                                    @error('address')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group"><label for="job" class=" form-control-label">Công việc</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="text" id="job" name="job" value="{{ $farmer->job }}"
                                            class="form-control-success form-control">
                                    </div>
                                    @error('job')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group"> <label for="" class="form-check-label mr-5"> Ảnh </label>
                                    <div class="small-12 medium-2 large-2 columns">
                                        <div class="circle">
                                            <img class="profile-pic" src="{{ url('uploads') }}/{{ $farmer->image }}">
                                        </div>
                                        <div class="p-image">
