...
@section('main')
    ...
    <div class="content">
        <div class="animated fadeIn">
            <form action="{{ route('banner.update', $banner->slug) }}" method="post" class="form-horizontal"
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                @csrf @method('PUT')
                                <div class="form-group"><label for="title" class=" form-control-label">Tiêu đề</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                        <input type="text" id="title" name="slogan" value="{{ $banner->slogan }}"
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    <img src="{{ url('uploads') }}/{{ $banner->image }}" alt="" srcset=""
