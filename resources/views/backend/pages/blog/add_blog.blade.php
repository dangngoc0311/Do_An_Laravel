...
@section('main')
    ...
    <div class="content">
        <div class="animated fadeIn">
            <form action="{{ route('bai-viet.store') }}" method="post" class="horizontal" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                        ...
                                        <select name="category_blogs_id" id="select1" class="form-control">
                                            ...
                                            @foreach ($categoryBlog as $cates)
                                                <option value="{{ $cates->id }}"
                                                    {{ old('category_blogs_id') == $cates->id ? 'selected' : '' }}>
                                                    {{ $cates->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="content" rows="8" placeholder="Content..."
