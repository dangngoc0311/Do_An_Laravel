                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="{{ route('phuong-thuc-thanh-toan.store') }}" method="post" class="form-horizontal">
                                @csrf
                                <div class="form-group"><label for="title" class=" form-control-label">Tên phương thức thanh toán</label>
