...
@section('main')
    ...
    <div class="content">
        <div class="animated fadeIn">
            <form action="{{ route('nha-cung-cap.store') }}" method="post" class="horizontal"
                                ...
                                <div class=" form-group"><label for="email" class=" form-control-label">Email</label>
                                    <div class="input-group">
                                        ...
                                        <input type="email" id="email" name="email"
                                            class="form-control-success form-control" value="{{ old('email') }}">
                                    </div>
                                    @error('email')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    <div class="image-upload-wrap">
                                        <input class="file-upload-input" type='file' onchange="readURL(this);"
                                            accept="image/*" name="file" value="{{ old('file') }}">
                                        <div class="drag-text">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="about" value="{{ old('about') }}" id="about" rows="10"
                                        placeholder="Content..." class="form-control">{{ old('about') }}</textarea>
